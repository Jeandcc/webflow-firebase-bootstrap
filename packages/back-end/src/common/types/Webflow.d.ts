...
declare module "webflow-api" {
  class Webflow {
    ...
    info(
      query?: Webflow.WebflowQueryArg
    ): Promise<Webflow.WebflowApiModel.Info>;
    ...
    items(
      ...
      query?: Webflow.WebflowQueryArg
    ): Promise<{ items: Webflow.WebflowApiModel.CollectionItem[] }>;
  ...
  namespace Webflow {
    ...
    namespace WebflowApiModel {
      ...
      interface Site {
        ...
        webhook: OmitPropertyFromFirstArgOfFunction<
          Webflow["webhook"],
          "siteId"
        >;
      ...
      interface Collection {
        ...
        item: OmitPropertyFromFirstArgOfFunction<
          Webflow["item"],
          "collectionId"
        >;
       ...
       */
      interface CollectionFieldValidationOptions {
        id: string;
        name: string;
      }
      ...
      interface CollectionField {
        ...
        validations: {
          collectionId?: string;
          options?: CollectionFieldValidationOptions[];
        };
      }
